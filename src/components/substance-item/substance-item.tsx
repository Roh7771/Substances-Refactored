...
import { SubstanceType, ModalWindowStatus } from '../../types';
...
const SubstanceItem: React.FC<Props> = (props: Props) => {
  ...
  const onEditButtonClick = (substanceToEdit: SubstanceType) => {
    ...
    dispatch(appStatusActionCreators.setModalWindowStatus(ModalWindowStatus.EDIT));
  };
  ...
  const onDeleteButtonClick = (substanceToDelete: SubstanceType) => {
    ...
    dispatch(appStatusActionCreators.setModalWindowStatus(ModalWindowStatus.DELETE));
  };
