...
export type AppStatusActionTypes = SetModalWindowStatusActionType | SetErrorStatusActionType |
SetSessionCheckingStatusActionType | SetRequestLoadingStatusActionType
